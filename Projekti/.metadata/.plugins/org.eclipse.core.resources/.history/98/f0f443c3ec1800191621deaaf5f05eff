 ...
 */
@WebServlet("/NajamActionServlet")
public class NajamActionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public NajamActionServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (imeSesije == null) {
			...
			try {
				...
				stmt.execute("INSERT INTO Najam (filmId,korisnikIme,cena) VALUES ('" + filmId + "','" + imeSesije + "',100)");
